...
[![Vue](https://img.shields.io/badge/Vue-3.x-41b883)](https://vuejs.org/)
[![Element Plus](https://img.shields.io/badge/Element_Plus-latest-409eff)](https://element-plus.org/)
...
### 首页浏览
首页展示热门推荐、最新上架和编辑精选内容。可以点击顶部导航切换不同内容分类，或使用搜索功能查找特定影片。支持按分类浏览电影、电视剧、动漫、综艺和短剧。

### 分类导航
- **电影区**: 包括动作片、喜剧片、爱情片等多种类型
- **电视剧区**: 提供国产剧、港台剧、日韩剧、欧美剧等分类
- **动漫区**: 有国产动漫、日本动漫、欧美动漫等选择
- **综艺区**: 包含各类综艺节目
- **短剧区**: 提供当下流行的短剧内容
...
#### Q: 影片详情页面加载很慢
- 我们已优化影片详情页的加载逻辑，采用异步加载机制
- 默认只加载主要信息和当前所选播放源，其他播放源在后台异步加载
- 如仍然加载缓慢，可尝试刷新页面或检查网络连接
